...
int vkContext::initContext()
{
  try
  {
    ...
    m_uboVP.view = glm::lookAt(glm::vec3(0.0f, 0.0f, 3.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
...
void vkContext::cleanupContext()
{
  ...
  vkDestroyImageView(m_device.logical, m_depthBufferImageView, nullptr);
  vkDestroyImage(m_device.logical, m_depthBufferImage, nullptr);
  vkFreeMemory(m_device.logical, m_depthBufferImageMemory, nullptr);
