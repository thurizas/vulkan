...
mesh::mesh(VkPhysicalDevice phyDevice, VkDevice logDevice, VkQueue xferQueue, VkCommandPool xferCmdPool, std::vector<vertex>* vertices, std::vector<uint32_t>* indices, int newTexId)
{
