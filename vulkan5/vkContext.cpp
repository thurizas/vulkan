...
int vkContext::initContext()
{
  try
  {
    ...
    mesh fstmesh = mesh(m_device.physical, m_device.logical, m_graphicsQueue, m_graphicsCommandPool, &meshVertices, &meshIndices, createTexture("giraffe.jpg"));
    mesh scdmesh = mesh(m_device.physical, m_device.logical, m_graphicsQueue, m_graphicsCommandPool, &meshVertices2, &meshIndices, createTexture("panda.jpg"));
